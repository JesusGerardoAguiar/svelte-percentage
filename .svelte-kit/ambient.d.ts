...
declare module '$env/static/private' {
	...
	export const npm_config__NAMESPACE_registry: string;
	...
	export const npm_config__JesusGerardoAguiar_registry: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_config__NAMESPACE_registry: string;
		...
		npm_config__JesusGerardoAguiar_registry: string;
